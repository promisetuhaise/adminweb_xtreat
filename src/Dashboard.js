...
const Dashboard = () => {
  ...
  // Sample data for the order list table
  const orders = [
    {
      id: '#583488/80',
  ...
  const handleViewOrder = (orderId) => {
    // Remove any # or / characters that might cause issues in the URL
                  ...
                  <span
                    className={`status ${
                      order.paymentStatus.toLowerCase() === 'paid'
                        ? 'paid'
                        : order.paymentStatus.toLowerCase() === 'refund'
                        ? 'refund'
                        : 'unpaid'
                    }`}
                  >
                  ...
                  <span
                    className={`status ${
                      order.orderStatus.toLowerCase() === 'completed'
                        ...
                        ? 'canceled'
                        : order.orderStatus.toLowerCase() === 'packaging'
                        ? 'packaging'
                        : 'draft'
                    }`}
                  >
